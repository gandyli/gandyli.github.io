...
(function(f){if(typeof exports==="object"&&typeof module!=="undefined"){module.exports=f()}else if(typeof define==="function"&&define.amd){define([],f)}else{var g;if(typeof window!=="undefined"){g=window}else if(typeof global!=="undefined"){g=global}else if(typeof self!=="undefined"){g=self}else{g=this}g.videojs = f()}})(function(){var define,module,exports;return (function e(t,n,r){function s(o,u){if(!n[o]){if(!t[o]){var a=typeof require=="function"&&require;if(!u&&a)return a(o,!0);if(i)return i(o,!0);var f=new Error("Cannot find module '"+o+"'");throw f.code="MODULE_NOT_FOUND",f}var l=n[o]={exports:{}};t[o][0].call(l.exports,function(e){var n=t[o][1][e];return s(n?n:e)},l,l.exports,e,t,n,r)}return n[o].exports}var i=typeof require=="function"&&require;for(var o=0;o<r.length;o++)s(r[o]);return s})({1:[function(_dereq_,module,exports){="" 'use="" strict';="" exports.__esmodule="true;" var="" _button="_dereq_(2);" _button2="_interopRequireDefault(_button);" _component="_dereq_(5);" _component2="_interopRequireDefault(_component);" function="" _interoprequiredefault(obj)="" {="" return="" obj="" &&="" obj.__esmodule="" ?="" :="" 'default':="" };="" }="" _classcallcheck(instance,="" constructor)="" if="" (!(instance="" instanceof="" constructor))="" throw="" new="" typeerror("cannot="" call="" a="" class="" as="" function");="" _possibleconstructorreturn(self,="" call)="" (!self)="" referenceerror("this="" hasn't="" been="" initialised="" -="" super()="" called");="" (typeof="" "object"="" ||="" typeof="" "function")="" self;="" _inherits(subclass,="" superclass)="" superclass="" !="=" "function"="" null)="" typeerror("super="" expression="" must="" either="" be="" null="" or="" function,="" not="" "="" +="" superclass);="" subclass.prototype="Object.create(superClass" superclass.prototype,="" constructor:="" value:="" subclass,="" enumerable:="" false,="" writable:="" true,="" configurable:="" true="" });="" (superclass)="" object.setprototypeof="" object.setprototypeof(subclass,="" subclass.__proto__="superClass;" **="" *="" @file="" big-play-button.js="" the="" initial="" play="" button="" that="" shows="" before="" video="" has="" played.="" hiding="" of="" `bigplaybutton`="" get="" done="" via="" css="" and="" `player`="" states.="" @extends="" bigplaybutton="function" (_button)="" _inherits(bigplaybutton,="" _button);="" bigplaybutton()="" _classcallcheck(this,="" bigplaybutton);="" _possibleconstructorreturn(this,="" _button.apply(this,="" arguments));="" builds="" default dom="" `classname`.="" @return="" {string}="" `classname`="" for="" this="" object.="" always="" returns="" 'vjs-big-play-button'.="" bigplaybutton.prototype.buildcssclass="function" buildcssclass()="" 'vjs-big-play-button';="" gets="" called="" when="" "clicked".="" see="" {@link="" clickablecomponent}="" more="" detailed="" information="" on="" what="" click="" can="" be.="" @param="" {eventtarget~event}="" event="" `keydown`,="" `tap`,="" `click`="" caused="" to="" called.="" @listens="" tap="" bigplaybutton.prototype.handleclick="function" handleclick(event)="" this.player_.play();="" cb="this.player_.getChild('controlBar');" playtoggle="cb" cb.getchild('playtoggle');="" (!playtoggle)="" this.player_.focus();="" return;="" this.settimeout(function="" ()="" playtoggle.focus();="" },="" 1);="" bigplaybutton;="" }(_button2['default']);="" text="" should="" display="" over="" `bigplaybutton`s="" controls.="" added="" localization.="" @type="" @private="" bigplaybutton.prototype.controltext_="Play Video" ;="" _component2['default'].registercomponent('bigplaybutton',="" exports['default']="BigPlayButton;" },{"2":2,"5":5}],2:[function(_dereq_,module,exports){="" _clickablecomponent="_dereq_(3);" _clickablecomponent2="_interopRequireDefault(_clickableComponent);" _log="_dereq_(86);" _log2="_interopRequireDefault(_log);" _obj="_dereq_(88);" button.js="" base="" all="" buttons.="" clickablecomponent="" (_clickablecomponent)="" _inherits(button,="" _clickablecomponent);="" button()="" button);="" _clickablecomponent.apply(this,="" create="" `button`s="" element.="" [tag="button]" element's="" node="" type.="" e.g.="" 'button'="" {object}="" [props="{}]" an="" object="" properties="" set="" [attributes="{}]" attributes="" {element}="" element="" created.="" button.prototype.createel="function" createel()="" tag="arguments.length"> 0 && arguments[0] !== undefined ? arguments[0] : 'button';
...
var ChaptersTrackMenuItem = function (_MenuItem) {
  ...
  function ChaptersTrackMenuItem(player, options) {
    ...
    options.selected = cue.startTime <= currenttime="" &&="" <="" cue.endtime;="" var="" _this="_possibleConstructorReturn(this," _menuitem.call(this,="" player,="" options));="" _this.track="track;" _this.cue="cue;" track.addeventlistener('cuechange',="" fn.bind(_this,="" _this.update));="" return="" _this;="" }="" **="" *="" this="" gets="" called="" when="" an="" `chapterstrackmenuitem`="" is="" "clicked".="" see="" {@link="" clickablecomponent}="" for="" more="" detailed="" information="" on="" what="" a="" click="" can="" be.="" @param="" {eventtarget~event}="" [event]="" the="" `keydown`,="" `tap`,="" or="" `click`="" event="" that="" caused="" function="" to="" be="" called.="" @listens="" tap="" chapterstrackmenuitem.prototype.handleclick="function" handleclick(event)="" {="" _menuitem.prototype.handleclick.call(this);="" this.player_.currenttime(this.cue.starttime);="" this.update(this.cue.starttime);="" };="" update="" chapter="" menu="" item="" `cuechange`="" run.="" texttrack#cuechange="" chapterstrackmenuitem.prototype.update="function" update(event)="" cue="this.cue;" vjs.log(currenttime,="" cue.starttime);="" this.selected(cue.starttime="" cue.endtime);="" chapterstrackmenuitem;="" }(_menuitem2['default']);="" _component2['default'].registercomponent('chapterstrackmenuitem',="" chapterstrackmenuitem);="" exports['default']="ChaptersTrackMenuItem;" },{"48":48,"5":5,"83":83}],27:[function(_dereq_,module,exports){="" 'use="" strict';="" exports.__esmodule="true;" _texttrackbutton="_dereq_(30);" _texttrackbutton2="_interopRequireDefault(_textTrackButton);" _component="_dereq_(5);" _component2="_interopRequireDefault(_component);" _fn="_dereq_(83);" fn="_interopRequireWildcard(_fn);" _interoprequirewildcard(obj)="" if="" (obj="" obj.__esmodule)="" obj;="" else="" newobj="{};" !="null)" (var="" key="" in="" obj)="" (object.prototype.hasownproperty.call(obj,="" key))="" newobj[key]="obj[key];" newobj['default']="obj;" newobj;="" _interoprequiredefault(obj)="" obj="" obj.__esmodule="" ?="" :="" 'default':="" _classcallcheck(instance,="" constructor)="" (!(instance="" instanceof="" constructor))="" throw="" new="" typeerror("cannot="" call="" class="" as="" function");="" _possibleconstructorreturn(self,="" call)="" (!self)="" referenceerror("this="" hasn't="" been="" initialised="" -="" super()="" called");="" (typeof="" "object"="" ||="" typeof="" "function")="" self;="" _inherits(subclass,="" superclass)="" superclass="" "function"="" null)="" typeerror("super="" expression="" must="" either="" null="" function,="" not="" "="" +="" superclass);="" subclass.prototype="Object.create(superClass" superclass.prototype,="" constructor:="" value:="" subclass,="" enumerable:="" false,="" writable:="" true,="" configurable:="" true="" });="" (superclass)="" object.setprototypeof="" object.setprototypeof(subclass,="" subclass.__proto__="superClass;" @file="" descriptions-button.js="" button="" component="" toggling="" and="" selecting="" descriptions="" @extends="" texttrackbutton="" descriptionsbutton="function" (_texttrackbutton)="" _inherits(descriptionsbutton,="" _texttrackbutton);="" creates="" instance="" of="" class.="" {player}="" player="" `player`="" should="" attached="" to.="" {object}="" [options]="" value="" store="" options.="" {component~readycallback}="" [ready]="" ready.="" descriptionsbutton(player,="" options,="" ready)="" _classcallcheck(this,="" descriptionsbutton);="" _texttrackbutton.call(this,="" ready));="" _this.el_.setattribute('aria-label',="" 'descriptions="" menu');="" tracks="player.textTracks();" (tracks)="" changehandler="Fn.bind(_this," _this.handletrackschange);="" tracks.addeventlistener('change',="" changehandler);="" _this.on('dispose',="" ()="" tracks.removeeventlistener('change',="" handle="" text="" track="" change="" run="" texttracklist#change="" descriptionsbutton.prototype.handletrackschange="function" handletrackschange(event)="" disabled="false;" check="" whether="" different="" kind="" showing="" i="0," l="tracks.length;" l;="" i++)="" (track.kind="" this.kind_="" track.mode="==" 'showing')="" break;="" another="" showing,="" disable="" (disabled)="" this.disable();="" this.enable();="" builds="" default dom="" `classname`.="" @return="" {string}="" `classname`="" object.="" descriptionsbutton.prototype.buildcssclass="function" buildcssclass()="" 'vjs-descriptions-button="" '="" _texttrackbutton.prototype.buildcssclass.call(this);="" descriptionsbutton;="" }(_texttrackbutton2['default']);="" `kind`="" texttrack="" look="" associate="" it="" with="" menu.="" @type="" @private="" descriptionsbutton.prototype.kind_="descriptions" ;="" display="" over="" `descriptionsbutton`s="" controls.="" added="" localization.="" descriptionsbutton.prototype.controltext_="Descriptions" _component2['default'].registercomponent('descriptionsbutton',="" },{"30":30,"5":5,"83":83}],28:[function(_dereq_,module,exports){="" _texttrackmenuitem="_dereq_(31);" _texttrackmenuitem2="_interopRequireDefault(_textTrackMenuItem);" off-text-track-menu-item.js="" special="" turning="" specific="" type="" texttrackmenuitem="" offtexttrackmenuitem="function" (_texttrackmenuitem)="" _inherits(offtexttrackmenuitem,="" _texttrackmenuitem);="" offtexttrackmenuitem(player,="" options)="" offtexttrackmenuitem);="" create="" pseudo="" info="" requires="" options['kind']="" options.track="{" player:="" kind:="" options.kind,="" label:="" options.kind="" off',="" mode:="" 'disabled'="" menuitem="" selectable="" options.selectable="true;" _texttrackmenuitem.call(this,="" _this.selected(true);="" offtexttrackmenuitem.prototype.handletrackschange="function" selected="true;" this.track.kind="" this.selected(selected);="" offtexttrackmenuitem;="" }(_texttrackmenuitem2['default']);="" _component2['default'].registercomponent('offtexttrackmenuitem',="" },{"31":31,"5":5}],29:[function(_dereq_,module,exports){="" subtitles-button.js="" subtitles="" subtitlesbutton="function" _inherits(subtitlesbutton,="" subtitlesbutton(player,="" subtitlesbutton);="" 'subtitles="" subtitlesbutton.prototype.buildcssclass="function" 'vjs-subtitles-button="" subtitlesbutton;="" subtitlesbutton.prototype.kind_="subtitles" `subtitlesbutton`s="" subtitlesbutton.prototype.controltext_="Subtitles" _component2['default'].registercomponent('subtitlesbutton',="" },{"30":30,"5":5}],30:[function(_dereq_,module,exports){="" _trackbutton="_dereq_(36);" _trackbutton2="_interopRequireDefault(_trackButton);" _offtexttrackmenuitem="_dereq_(28);" _offtexttrackmenuitem2="_interopRequireDefault(_offTextTrackMenuItem);" text-track-button.js="" base="" buttons="" toggle="" types="" (e.g.="" subtitles)="" menubutton="" (_trackbutton)="" _inherits(texttrackbutton,="" _trackbutton);="" [options="{}]" texttrackbutton(player)="" options="arguments.length"> 1 && arguments[1] !== undefined ? arguments[1] : {};
...
var TrackButton = function (_MenuButton) {
  ...
  function TrackButton(player, options) {
    ...
    if (_this.items.length <= 1)="" {="" _this.hide();="" }="" if="" (!tracks)="" return="" _possibleconstructorreturn(_this);="" var="" updatehandler="Fn.bind(_this," _this.update);="" tracks.addeventlistener('removetrack',="" updatehandler);="" tracks.addeventlistener('addtrack',="" _this.player_.on('dispose',="" function="" ()="" tracks.removeeventlistener('removetrack',="" tracks.removeeventlistener('addtrack',="" });="" _this;="" trackbutton;="" }(_menubutton2['default']);="" _component2['default'].registercomponent('trackbutton',="" trackbutton);="" exports['default']="TrackButton;" },{"47":47,"5":5,"83":83}],37:[function(_dereq_,module,exports){="" 'use="" strict';="" exports.__esmodule="true;" _slider="_dereq_(57);" _slider2="_interopRequireDefault(_slider);" _component="_dereq_(5);" _component2="_interopRequireDefault(_component);" _fn="_dereq_(83);" fn="_interopRequireWildcard(_fn);" _dereq_(39);="" _interoprequirewildcard(obj)="" (obj="" &&="" obj.__esmodule)="" obj;="" else="" newobj="{};" !="null)" for="" (var="" key="" in="" obj)="" (object.prototype.hasownproperty.call(obj,="" key))="" newobj[key]="obj[key];" newobj['default']="obj;" newobj;="" _interoprequiredefault(obj)="" obj="" obj.__esmodule="" ?="" :="" 'default':="" };="" _classcallcheck(instance,="" constructor)="" (!(instance="" instanceof="" constructor))="" throw="" new="" typeerror("cannot="" call="" a="" class="" as="" function");="" _possibleconstructorreturn(self,="" call)="" (!self)="" referenceerror("this="" hasn't="" been="" initialised="" -="" super()="" called");="" (typeof="" "object"="" ||="" typeof="" "function")="" self;="" _inherits(subclass,="" superclass)="" superclass="" "function"="" null)="" typeerror("super="" expression="" must="" either="" be="" null="" or="" function,="" not="" "="" +="" superclass);="" subclass.prototype="Object.create(superClass" superclass.prototype,="" constructor:="" value:="" subclass,="" enumerable:="" false,="" writable:="" true,="" configurable:="" true="" (superclass)="" object.setprototypeof="" object.setprototypeof(subclass,="" subclass.__proto__="superClass;" **="" *="" @file="" volume-bar.js="" required children="" the="" bar="" that="" contains="" volume="" level="" and="" can="" clicked="" on="" to="" adjust="" @extends="" slider="" volumebar="function" (_slider)="" _inherits(volumebar,="" _slider);="" creates="" an="" instance="" of="" this="" class.="" @param="" {player}="" player="" `player`="" should="" attached="" to.="" {object}="" [options]="" value="" store="" options.="" volumebar(player,="" options)="" _classcallcheck(this,="" volumebar);="" _this="_possibleConstructorReturn(this," _slider.call(this,="" player,="" options));="" _this.on(player,="" 'volumechange',="" _this.updateariaattributes);="" player.ready(fn.bind(_this,="" _this.updateariaattributes));="" create="" `component`'s="" dom="" element="" @return="" {element}="" was="" created.="" volumebar.prototype.createel="function" createel()="" _slider.prototype.createel.call(this,="" 'div',="" classname:="" 'vjs-volume-bar="" vjs-slider-bar'="" },="" 'aria-label':="" 'volume="" level'="" handle="" movement="" events="" {@link="" volumemenubutton}.="" {eventtarget~event}="" event="" caused="" run.="" @listens="" mousemove="" volumebar.prototype.handlemousemove="function" handlemousemove(event)="" this.checkmuted();="" this.player_.volume(this.calculatedistance(event));="" is="" muted unmute="" it.="" volumebar.prototype.checkmuted="function" checkmuted()="" (this.player_.muted())="" this.player_.muted(false);="" get="" percent="" {number}="" decimal="" number.="" volumebar.prototype.getpercent="function" getpercent()="" 0;="" this.player_.volume();="" increase="" keyboard="" users="" volumebar.prototype.stepforward="function" stepforward()="" this.player_.volume(this.player_.volume()="" 0.1);="" decrease="" volumebar.prototype.stepback="function" stepback()="" update="" aria="" accessibility="" attributes="" [event]="" `volumechange`="" player#volumechange="" volumebar.prototype.updateariaattributes="function" updateariaattributes(event)="" current="" percentage="" 100).tofixed(2);="" this.el_.setattribute('aria-valuenow',="" volume);="" this.el_.setattribute('aria-valuetext',="" '%');="" volumebar;="" }(_slider2['default']);="" default options="" `volumebar`="" @type="" @private="" volumebar.prototype.options_="{" children:="" ['volumelevel'],="" barname:="" 'volumelevel'="" when="" happens="" player.="" {string}="" volumebar.prototype.playerevent="volumechange" ;="" _component2['default'].registercomponent('volumebar',="" },{"39":39,"5":5,"57":57,"83":83}],38:[function(_dereq_,module,exports){="" _dereq_(37);="" volume-control.js="" component="" controlling="" volumecontrol="function" (_component)="" _inherits(volumecontrol,="" _component);="" [options="{}]" volumecontrol(player,="" volumecontrol);="" hide="" controls they're="" supported="" by="" tech="" _component.call(this,="" (player.tech_="" player.tech_.featuresvolumecontrol="==" false)="" _this.addclass('vjs-hidden');="" 'loadstart',="" (player.tech_.featuresvolumecontrol="==" this.addclass('vjs-hidden');="" this.removeclass('vjs-hidden');="" volumecontrol.prototype.createel="function" _component.prototype.createel.call(this,="" 'vjs-volume-control="" vjs-control'="" volumecontrol;="" }(_component2['default']);="" `volumecontrol`="" volumecontrol.prototype.options_="{" ['volumebar']="" _component2['default'].registercomponent('volumecontrol',="" },{"37":37,"5":5}],39:[function(_dereq_,module,exports){="" volume-level.js="" shows="" volumelevel="function" _inherits(volumelevel,="" volumelevel()="" volumelevel);="" _possibleconstructorreturn(this,="" _component.apply(this,="" arguments));="" volumelevel.prototype.createel="function" 'vjs-volume-level',="" innerhtml:="" '<span="">'
    });
  };
...
var MenuButton = function (_ClickableComponent) {
  ...
  MenuButton.prototype.update = function update() {
    ...
    if (this.items && this.items.length <= 0="" 27="" 38="" this.hidethreshold_)="" {="" this.hide();="" }="" else="" this.show();="" };="" **="" *="" create="" the="" menu="" and="" add="" all="" items="" to="" it.="" @return="" {menu}="" constructed="" menubutton.prototype.createmenu="function" createmenu()="" var="" _menu2['default'](this.player_);="" hide="" if="" number="" of="" is="" less="" than="" or="" equal="" this="" threshold.="" defaults="" whenever="" we="" which="" can="" be="" hidden we'll="" increment="" list="" it="" here="" because="" every="" time="" run="" `createmenu`="" need="" reset="" value.="" @protected="" @type="" {number}="" this.hidethreshold_="0;" a="" title="" item="" top="" (this.options_.title)="" classname:="" 'vjs-menu-title',="" innerhtml:="" (0,="" _totitlecase2['default'])(this.options_.title),="" tabindex:="" -1="" });="" +="1;" menu.children_.unshift(title);="" dom.insertelfirst(title,="" menu.contentel());="" this.items="this.createItems();" (this.items)="" for="" (var="" i="0;" <="" this.items.length;="" i++)="" menu.additem(this.items[i]);="" return="" menu;="" items.="" specific="" each="" subclass.="" @abstract="" menubutton.prototype.createitems="function" createitems()="" {};="" `menubuttons`s="" dom="" element.="" {element}="" element="" that="" gets="" created.="" menubutton.prototype.createel="function" createel()="" _clickablecomponent.prototype.createel.call(this,="" 'div',="" this.buildcssclass()="" builds="" default `classname`.="" {string}="" `classname`="" object.="" menubutton.prototype.buildcssclass="function" buildcssclass()="" menubuttonclass="vjs-menu-button" ;="" inline="" option="" passed,="" want="" use="" different="" styles="" altogether.="" (this.options_.inline="==" true)="" 'vjs-menu-button="" '="" _clickablecomponent.prototype.buildcssclass.call(this);="" handle="" click="" on="" `menubutton`.="" see="" {@link="" clickablecomponent#handleclick}="" instances="" where="" called.="" @param="" {eventtarget~event}="" event="" `keydown`,="" `tap`,="" `click`="" caused="" function="" @listens="" tap="" menubutton.prototype.handleclick="function" handleclick(event)="" when="" you="" button="" adds="" focus,="" will="" show="" menu.="" so="" remove="" focus="" mouse="" leaves="" button.="" needed="" tab="" navigation.="" this.one(this.menu.contentel(),="" 'mouseleave',="" fn.bind(this,="" (e)="" this.unpressbutton();="" this.el_.blur();="" }));="" (this.buttonpressed_)="" this.pressbutton();="" tab,="" escape,="" down="" arrow,="" up="" arrow="" keys="" clickablecomponent#handlekeypress}="" `keydown`="" keydown="" menubutton.prototype.handlekeypress="function" handlekeypress(event)="" escape="" (27)="" key="" (9)="" unpress="" 'button'="" (event.which="==" ||="" event.which="==" 9)="" don't="" preventdefault="" -="" still="" lose="" !="=" event.preventdefault();="" (38)="" (40)="" press="" 40)="" (!this.buttonpressed_)="" _clickablecomponent.prototype.handlekeypress.call(this,="" event);="" sub-menu.="" listener="" added="" in="" constructor.="" menubutton.prototype.handlesubmenukeypress="function" handlesubmenukeypress(event)="" put="" current="" `menubutton`="" into="" pressed="" state.="" menubutton.prototype.pressbutton="function" pressbutton()="" (this.enabled_)="" this.buttonpressed_="true;" this.menu.lockshowing();="" this.el_.setattribute('aria-expanded',="" 'true');="" set="" submenu="" this.menu.focus();="" take="" out="" menubutton.prototype.unpressbutton="function" unpressbutton()="" this.menu.unlockshowing();="" 'false');="" back="" this.el_.focus();="" disable="" allow="" clicked.="" {menubutton}="" returns="" itself;="" method="" chained.="" menubutton.prototype.disable="function" disable()="" unpress,="" but="" force="" this.enabled_="false;" _clickablecomponent.prototype.disable.call(this);="" enable="" menubutton.prototype.enable="function" enable()="" _clickablecomponent.prototype.enable.call(this);="" menubutton;="" }(_clickablecomponent2['default']);="" _component2['default'].registercomponent('menubutton',="" menubutton);="" exports['default']="MenuButton;" },{"3":3,"49":49,"5":5,"81":81,"83":83,"91":91}],48:[function(_dereq_,module,exports){="" 'use="" strict';="" exports.__esmodule="true;" _clickablecomponent="_dereq_(3);" _clickablecomponent2="_interopRequireDefault(_clickableComponent);" _component="_dereq_(5);" _component2="_interopRequireDefault(_component);" _obj="_dereq_(88);" _interoprequiredefault(obj)="" obj="" &&="" obj.__esmodule="" ?="" :="" 'default':="" _classcallcheck(instance,="" constructor)="" (!(instance="" instanceof="" constructor))="" throw="" new="" typeerror("cannot="" call="" class="" as="" function");="" _possibleconstructorreturn(self,="" call)="" (!self)="" referenceerror("this="" hasn't="" been="" initialised="" super()="" called");="" (typeof="" "object"="" typeof="" "function")="" self;="" _inherits(subclass,="" superclass)="" superclass="" "function"="" null)="" typeerror("super="" expression="" must="" either="" null="" function,="" not="" "="" superclass);="" subclass.prototype="Object.create(superClass" superclass.prototype,="" constructor:="" value:="" subclass,="" enumerable:="" false,="" writable:="" true,="" configurable:="" true="" (superclass)="" object.setprototypeof="" object.setprototypeof(subclass,="" subclass.__proto__="superClass;" @file="" menu-item.js="" component="" item.="" `<li="">`
 *
 * @extends ClickableComponent
 */
...
Flash.getEmbedCode = function (swf, flashVars, params, attributes) {
  var objTag = '<object type="application/x-shockwave-flash" ';="" var="" flashvarsstring="" ;="" paramsstring="" attrsstring="" convert="" flash="" vars="" to="" string="" if="" (flashvars)="" {="" object.getownpropertynames(flashvars).foreach(function="" (key)="" +="key" '=" + flashVars[key] + " &amp;';="" });="" }="" add="" swf,="" flashvars,="" and="" other="" default params="" _obj.assign)({="" movie:="" flashvars:="" flashvarsstring,="" required talk="" swf="" allowscriptaccess:="" 'always',="" all="" should="" be="" default,="" but="" having="" security="" issues.="" allownetworking:="" 'all'="" },="" params);="" create="" param="" tags="" object.getownpropertynames(params).foreach(function="" key="" '"="" value="' + params[key] + '">';
  });
...
var Html5 = function (_Tech) {
  ...
  Html5.prototype.enterFullScreen = function enterFullScreen() {
    ...
    if (video.paused && video.networkState <= video.have_metadata)="" {="" attempt="" to="" prime="" the="" video="" element="" for="" programmatic="" access="" this="" isn't="" necessary="" on="" desktop="" but="" shouldn't="" hurt="" this.el_.play();="" playing="" and="" pausing="" synchronously="" during="" transition="" fullscreen="" can="" get="" ios="" ~6.1="" devices="" into="" a="" play="" pause="" loop this.settimeout(function="" ()="" video.pause();="" video.webkitenterfullscreen();="" },="" 0);="" }="" else="" };="" **="" *="" request="" that="" `html5`="" tech="" exit="" fullscreen.="" html5.prototype.exitfullscreen="function" exitfullscreen()="" this.el_.webkitexitfullscreen();="" getter="" setter="" tech's="" source="" object.=""> Note: Please use {@link Html5#setSource}
   *
   * @param {Tech~SourceObject} [src]
...
//   a customized way.
// `selector`:
//   The selector used to find the associated </select><select> element.
var selectConfigs = {
  backgroundColor: {
...
/**
 * Gets the value of the selected <option> element within a </option></select><select> element.
 *
 * @param  {Element} el
...
/**
 * Sets the selected <option> element within a </option></select><select> element based on a
 * given value.
 *
 * @param {Element} el
 *        The element to look in.
...
var TextTrackSettings = function (_Component) {
  ...
  /**
   * Create a </select><select> element with configured options.
   *
   * @param {string} key
  ...
  /**
   * Sets all </select><select> elements to their default values.
   */
...
function _cleanUpEvents(elem, type) {
  ...
  if (Object.getOwnPropertyNames(data.handlers).length <= 0="=" 1="=" 2="=" 4="" 0)="" {="" delete="" data.handlers;="" data.dispatcher;="" data.disabled;="" }="" finally="" remove="" the="" element="" data="" if="" there="" is="" no="" left="" (object.getownpropertynames(data).length="==" dom.removeeldata(elem);="" **="" *="" loops="" through="" an="" array="" of="" event="" types="" and="" calls="" requested="" method="" for="" each="" type.="" @param="" {function}="" fn="" we="" want="" to="" use.="" {element|object}="" elem="" or="" object="" bind="" listeners="" {string}="" type="" to.="" {eventtarget~eventlistener}="" callback="" listener.="" @file="" events.js.="" system="" (john="" resig="" -="" secrets="" a="" js="" ninja="" http:="" jsninja.com="" )="" (original="" book="" version="" wasn't="" completely="" usable,="" so="" fixed="" some="" things="" made="" closure="" compiler="" compatible)="" this="" should="" work="" very="" similarly="" jquery's="" events,="" however="" it's="" based="" off="" which="" isn't="" as="" robust="" jquery's,="" there's="" probably="" differences.="" @module="" events="" function="" _handlemultipleevents(fn,="" elem,="" types,="" callback)="" types.foreach(function="" (type)="" call="" one="" fn(elem,="" type,="" callback);="" });="" fix="" native="" have="" standard="" property="" values="" {object}="" fix.="" @return="" object.="" fixevent(event)="" returntrue()="" return="" true;="" returnfalse()="" false;="" test="" fixing="" up="" needed="" used="" check="" !event.stoppropagation="" instead="" ispropagationstopped="" but="" true="" stoppropagation,="" don't="" other="" expected="" methods="" like="" ispropagationstopped.="" seems="" be="" problem="" with="" javascript="" code.="" we're="" just="" overriding="" all="" now.="" (!event="" ||="" !event.ispropagationstopped)="" var="" old="event" _window2['default'].event;="" clone="" that="" can="" modify="" ie8="" doesn't="" when="" you="" mess="" properties="" firefox="" returns="" false="" event.hasownproperty('type')="" props="" makes="" copying="" more="" difficult.="" todo:="" best="" create="" whitelist="" (var="" key="" in="" old)="" safari="" 6.0.3="" warns="" try="" copy="" deprecated="" layerx="" y="" chrome="" keyboardevent.keylocation="" webkitmovementx="" (key="" !="=" 'layerx'="" &&="" 'layery'="" 'keylocation'="" 'webkitmovementx'="" 'webkitmovementy')="" 32+="" returnvalue,="" still="" preventdefault="" supported="" (ie8).="" (!(key="==" 'returnvalue'="" old.preventdefault))="" event[key]="old[key];" occurred="" on="" (!event.target)="" event.target="event.srcElement" _document2['default'];="" handle="" related="" (!event.relatedtarget)="" event.relatedtarget="event.fromElement" =="=" ?="" event.toelement="" :="" event.fromelement;="" stop="" default browser="" action="" event.preventdefault="function" ()="" (old.preventdefault)="" old.preventdefault();="" event.returnvalue="false;" old.returnvalue="false;" event.defaultprevented="true;" };="" from="" bubbling="" event.stoppropagation="function" (old.stoppropagation)="" old.stoppropagation();="" event.cancelbubble="true;" old.cancelbubble="true;" event.ispropagationstopped="returnTrue;" executing="" handlers="" event.stopimmediatepropagation="function" (old.stopimmediatepropagation)="" old.stopimmediatepropagation();="" event.isimmediatepropagationstopped="returnTrue;" event.stoppropagation();="" mouse="" position="" (event.clientx="" null="" event.clientx="" undefined)="" doc="_document2['default'].documentElement;" body="_document2['default'].body;" event.pagex="event.clientX" +="" (doc="" doc.scrollleft="" body.scrollleft="" doc.clientleft="" body.clientleft="" 0);="" event.pagey="event.clientY" doc.scrolltop="" body.scrolltop="" doc.clienttop="" body.clienttop="" presses="" event.which="event.charCode" event.keycode;="" button="" clicks:="" left;="" middle;="" right="" (event.button="" event.button="" following="" disabled because="" it="" does="" not="" pass="" videojs-standard="" and...="" yikes.="" eslint-disable="" &="" 0;="" eslint-enable="" fixed-up="" instance="" event;="" add="" listener="" stores="" handler="" separate="" cache="" adds="" generic="" element's="" event,="" along="" unique="" id="" (guid)="" element.="" {string|string[]}="" on(elem,="" fn)="" (array.isarray(type))="" _handlemultipleevents(on,="" fn);="" need="" place="" store="" our="" (!data.handlers)="" data.handlers="{};" (!data.handlers[type])="" data.handlers[type]="[];" (!fn.guid)="" fn.guid="Guid.newGUID();" data.handlers[type].push(fn);="" (!data.dispatcher)="" data.disabled="false;" data.dispatcher="function" (event,="" hash)="" (data.disabled)="" return;="" (handlers)="" are="" added="" removed="" during="" process="" throw="" everything="" off.="" handlerscopy="handlers.slice(0);" m="0," n="handlersCopy.length;" <="" n;="" m++)="" (event.isimmediatepropagationstopped())="" break;="" else="" handlerscopy[m].call(elem,="" hash);="" catch="" (e)="" _log2['default'].error(e);="" (data.handlers[type].length="==" 1)="" (elem.addeventlistener)="" elem.addeventlistener(type,="" data.dispatcher,="" false);="" (elem.attachevent)="" elem.attachevent('on'="" data.dispatcher);="" removes="" from.="" [type]="" remove.="" include="" [fn]="" specific="" off(elem,="" geteldata="" (!dom.haseldata(elem))="" exist,="" nothing="" unbind="" _handlemultipleevents(off,="" utility="" removetype="function" removetype(t)="" data.handlers[t]="[];" _cleanupevents(elem,="" t);="" removing="" bound="" events?="" (!type)="" t="" data.handlers)="" removetype(t);="" (!handlers)="" was="" provided,="" (!fn)="" removetype(type);="" only="" single="" (fn.guid)="" handlers.length;="" n++)="" (handlers[n].guid="==" fn.guid)="" handlers.splice(n--,="" 1);="" type);="" trigger="" {eventtarget~event|string}="" string="" (the="" type)="" attribute="" [hash]="" hash="" {boolean|undefined}="" opposite="" `defaultprevented`="" prevented="" otherwise="" undefined="" trigger(elem,="" fetches="" reference="" parent="" (for="" bubbling).="" every="" parent,="" checking="" haseldata="" first.="" elemdata="Dom.hasElData(elem)" dom.geteldata(elem)="" {};="" elem.ownerdocument;="" handler;="" name="" passed="" string,="" creates="" out="" (typeof="" 'string')="" type:="" target:="" normalizes="" properties.="" has="" dispatcher,="" executes="" established="" handlers.="" (elemdata.dispatcher)="" elemdata.dispatcher.call(elem,="" unless="" explicitly="" stopped="" bubble="" (e.g.="" media="" events)="" recursively="" dom.="" (parent="" !event.ispropagationstopped()="" event.bubbles="==" true)="" trigger.call(null,="" at="" top="" dom,="" triggers="" disabled.="" (!parent="" !event.defaultprevented)="" targetdata="Dom.getElData(event.target);" checks="" target="" event.="" (event.target[event.type])="" temporarily="" disables="" dispatching="" already="" executed="" handler.="" targetdata.disabled="true;" action.="" event.target[event.type]="==" 'function')="" event.target[event.type]();="" re-enables="" dispatching.="" inform="" triggerer="" by="" returning="" !event.defaultprevented;="" once="" {event~eventlistener}="" one(elem,="" _handlemultipleevents(one,="" func="function" func()="" func);="" fn.apply(this,="" arguments);="" guid="" new="" using="" original="" function's="" func.guid="fn.guid" guid.newguid();="" },{"81":81,"85":85,"86":86,"94":94,"95":95}],83:[function(_dereq_,module,exports){="" 'use="" strict';="" exports.__esmodule="true;" exports.throttle="exports.bind" undefined;="" _guid="_dereq_(85);" (a.k.a="" proxy="" context).="" simple="" changing="" context="" also="" easily="" events.="" {mixed}="" scope.="" {number}="" [uid]="" optional="" set="" will="" into="" given="" bind(context,="" fn,="" uid)="" make="" sure="" _guid.newguid)();="" changes="" bound()="" fn.apply(context,="" allow="" ability="" individualize="" case="" where="" multiple objects="" might="" share="" same="" prototype="" both="" items="" function,="" then="" they="" guid.="" this,="" use="" well.="" currently="" text="" tracks="" bound.guid="uid" uid="" '_'="" fn.guid;="" bound;="" wraps="" `fn`,="" invokes="" `fn`="" most="" per="" `wait`="" milliseconds.="" throttled.="" wait="" number="" milliseconds="" throttle.="" fn.js="" throttle="exports.throttle" throttle(fn,="" wait)="" last="Date.now();" throttled="function" throttled()="" now="Date.now();" (now="">= wait) {
...
videojs.removeHook = function (type, fn) {
  ...
  if (index <= -1)="" {="" return="" false;="" }="" videojs.hooks_[type]="videojs.hooks_[type].slice();" videojs.hooks_[type].splice(index,="" 1);="" true;="" };="" add="" default styles="" if="" (_window2['default'].videojs_no_dynamic_style="" !="=" true="" &&="" dom.isreal())="" var="" style="Dom.$('.vjs-styles-defaults');" (!style)="" head="Dom.$('head');" (head)="" head.insertbefore(style,="" head.firstchild);="" stylesheet.settextcontent(style,="" '\n="" .video-js="" {\n="" width:="" 300px;\n="" height:="" 150px;\n="" }\n\n="" .vjs-fluid="" padding-top:="" 56.25%\n="" }\n="" ');="" run="" auto-load="" players="" you="" have="" to="" wait="" at="" least="" once="" in="" case="" this="" script="" is="" loaded="" after="" your="" video="" the="" dom="" (weird="" behavior="" only="" with="" minified="" version)="" setup.autosetuptimeout(1,="" videojs);="" **="" *="" current="" software="" version.="" follows="" semver.="" @type="" {string}="" videojs.version="5.19.2" ;="" global="" options="" object.="" these="" are="" settings="" that="" take="" effect="" no="" overrides="" specified="" when="" player="" created.="" {object}="" videojs.options="_player2['default'].prototype.options_;" get="" an="" object="" currently="" created="" players,="" keyed="" by="" id="" @return="" videojs.getplayers="function" ()="" _player2['default'].players;="" expose="" @memberof="" videojs="" @property="" videojs.players="_player2['default'].players;" a="" component="" class="" name="" @borrows="" component.getcomponent="" as="" videojs.getcomponent="" register="" so="" it="" can="" referred="" name.="" used="" adding="" other="" components,="" either="" through="" addchild="" `component.addchild('mycomponent')`="" or="" children="" `{="" children:="" ['mycomponent']="" }`.=""> NOTE: You could also just initialize the component before adding.
...
(function(global) {
  ...
  Settings.prototype = {
    ...
    percent: function(k, v) {
      ...
      if ((m = v.match(/^([\d]{1,3})(\.[\d]*)?%$/))) {
        v = parseFloat(v);
        if (v >= 0 && v <= 100)="" {="" this.set(k,="" v);="" return="" true;="" }="" false;="" };="" helper="" function="" to="" parse="" input="" into="" groups="" separated="" by="" 'groupdelim',="" and="" interprete="" each="" group="" as="" a="" key="" value="" pair="" 'keyvaluedelim'.="" parseoptions(input,="" callback,="" keyvaluedelim,="" groupdelim)="" var="" ?="" input.split(groupdelim)="" :="" [input];="" for="" (var="" i="" in="" groups)="" if="" (typeof="" groups[i]="" !="=" "string")="" continue;="" kv="groups[i].split(keyValueDelim);" (kv.length="" 2)="" k="kv[0];" v="kv[1];" callback(k,="" parsecue(input,="" cue,="" regionlist)="" remember="" the="" original="" we="" need="" throw="" an="" error.="" oinput="input;" 4.1="" webvtt="" timestamp="" consumetimestamp()="" ts="parseTimeStamp(input);" (ts="==" null)="" new="" parsingerror(parsingerror.errors.badtimestamp,="" "malformed="" timestamp:="" "="" +="" oinput);="" remove="" time="" stamp="" from="" input.="" "");="" ts;="" 4.4.2="" cue="" settings="" consumecuesettings(input,="" cue)="" settings();="" (k,="" v)="" switch="" (k)="" case="" "region":="" find="" last="" region="" parsed="" with="" same="" id.="" -="" 1;="">= 0; i--) {
  ...
  function parseContent(window, input) {
    ...
    while ((t = nextToken()) !== null) {
      if (t[0] === '<') {="" if="" (t[1]="==" "="" ")="" the="" closing="" tag="" matches,="" move="" back="" up="" to="" parent="" node.="" (tagstack.length="" &&="" tagstack[tagstack.length="" -="" 1]="==" t.substr(2).replace("="">", "")) {
            tagStack.pop();
  ...
  function isStrongRTLChar(charCode) {
    for (var i = 0; i < strongRTLRanges.length; i++) {
      ...
      if (charCode >= currentRange[0] && charCode <= currentrange[1])="" {="" return="" true;="" }="" false;="" function="" determinebidi(cuediv)="" var="" nodestack="[]," text="" ,="" charcode;="" if="" (!cuediv="" ||="" !cuediv.childnodes)="" "ltr";="" pushnodes(nodestack,="" node)="" for="" (var="" i="node.childNodes.length" -="" 1;="">= 0; i--) {
  ...
  function computeLinePos(cue) {
    if (typeof cue.line === "number" &&
        (cue.snapToLines || (cue.line >= 0 && cue.line <= 0="" 100)))="" {="" return="" cue.line;="" }="" if="" (!cue.track="" ||="" !cue.track.texttracklist="" !cue.track.texttracklist.mediaelement)="" -1;="" var="" track="cue.track," tracklist="track.textTrackList," count="0;" for="" (var="" i="0;" <="" tracklist.length="" &&="" tracklist[i]="" !="=" track;="" i++)="" (tracklist[i].mode="==" "showing")="" count++;="" ++count="" *="" function="" stylebox()="" apply="" styles="" to="" a="" div.="" there="" is="" no="" div="" passed="" then="" it="" defaults="" the="" on="" 'this'.="" stylebox.prototype.applystyles="function(styles," div)="" this.div;="" prop="" in="" styles)="" (styles.hasownproperty(prop))="" div.style[prop]="styles[prop];" };="" stylebox.prototype.formatstyle="function(val," unit)="" val="==" ?="" :="" +="" unit;="" constructs="" computed="" display="" state="" of="" cue="" (a="" div).="" places="" into="" overlay="" which="" should="" be="" block="" level="" element="" (usually="" cuestylebox(window,="" cue,="" styleoptions)="" isie8="(/MSIE\s8\.0/).test(navigator.userAgent);" color="rgba(255, 255, 255, 1)" ;="" backgroundcolor="rgba(0, 0, 0, 0.8)" (isie8)="" stylebox.call(this);="" this.cue="cue;" parse="" our="" cue's="" text="" dom="" tree="" rooted="" at="" 'cuediv'.="" this="" will="" have="" inline="" positioning="" and="" as="" background="" box.="" this.cuediv="parseContent(window," cue.text);="" color:="" color,="" backgroundcolor:="" backgroundcolor,="" position:="" "relative",="" left:="" 0,="" right:="" top:="" bottom:="" display:="" "inline"="" (!isie8)="" styles.writingmode="cue.vertical" =="=" ""="" "horizontal-tb"="" cue.vertical="==" "lr"="" "vertical-lr"="" "vertical-rl";="" styles.unicodebidi="plaintext" this.applystyles(styles,="" this.cuediv);="" create="" an="" absolutely="" positioned="" that="" used="" position="" note,="" all="" webvtt="" cue-setting="" alignments="" are="" equivalent="" css="" mirrors="" them="" except="" "middle"="" "center"="" css.="" this.div="window.document.createElement("div");" textalign:="" cue.align="==" cue.align,="" font:="" styleoptions.font,="" whitespace:="" "pre-line",="" "absolute"="" styles.direction="determineBidi(this.cueDiv);" "vertical-rl".="" stylesunicodebidi="plaintext" this.applystyles(styles);="" this.div.appendchild(this.cuediv);="" calculate="" distance="" from="" reference="" edge="" viewport="" resolved="" later="" when="" box="" orientation="" applied.="" textpos="0;" switch="" (cue.positionalign)="" case="" "start":="" break;="" "middle":="" -="" (cue.size="" 2);="" "end":="" cue.size;="" horizontal="" orientation;="" left="" area="" cue.size="" extending="" right="" there.="" (cue.vertical="==" "")="" this.applystyles({="" this.formatstyle(textpos,="" "%"),="" width:="" this.formatstyle(cue.size,="" "%")="" });="" vertical="" top="" height="" downwards="" else="" height:="" this.move="function(box)" this.formatstyle(box.top,="" "px"),="" this.formatstyle(box.bottom,="" this.formatstyle(box.left,="" this.formatstyle(box.right,="" this.formatstyle(box.height,="" this.formatstyle(box.width,="" "px")="" cuestylebox.prototype="_objCreate(StyleBox.prototype);" cuestylebox.prototype.constructor="CueStyleBox;" represents="" co-ordinates="" way="" we="" can="" easily="" compute="" things="" with="" such="" overlaps="" or="" intersects="" another="" element.="" initialize="" either="" stylebox="" boxposition.="" boxposition(obj)="" boxposition="" was="" need="" copy="" it,="" results="" 'getboundingclientrect'="" object="" returned="" readonly.="" co-ordinate="" values="" origin="" (top="" left).="" lh,="" height,="" width,="" top;="" (obj.div)="" width="obj.div.offsetWidth;" rects="(rects" obj.div.childnodes)="" (rects="rects[0])" rects.getclientrects="" rects.getclientrects();="" obj="obj.div.getBoundingClientRect();" certain="" cases="" outter="" slightly="" larger="" sum="" inner="" div's="" lines.="" could="" due="" bold="" text,="" etc,="" some="" platforms.="" get="" average="" line="" use="" that.="" result="" desired="" behaviour.="" lh="rects" math.max((rects[0]="" rects[0].height)="" obj.height="" rects.length)="" 0;="" this.left="obj.left;" this.right="obj.right;" this.top="obj.top" this.height="obj.height" height;="" this.bottom="obj.bottom" (obj.height="" height));="" this.width="obj.width" width;="" this.lineheight="lh" undefined="" obj.lineheight;="" (isie8="" !this.lineheight)="" move="" along="" particular="" axis.="" optionally="" pass="" amount="" default boxposition.prototype.move="function(axis," tomove)="" tomove="toMove" this.lineheight;="" (axis)="" "+x":="" "-x":="" "+y":="" "-y":="" check="" box,="" b2.="" boxposition.prototype.overlaps="function(b2)" b2.right=""> b2.left &&
           this.top < b2.bottom &&
           this.bottom > b2.top;
  };
  ...
  BoxPosition.prototype.within = function(container) {
    return this.top >= container.top &&
           this.bottom <= container.bottom="" &&="" this.left="">= container.left &&
           this.right <= container.right;="" };="" check="" if="" this="" box="" is="" entirely="" within="" the="" container="" or="" it="" overlapping="" on="" edge="" opposite="" of="" axis="" direction="" passed.="" for="" example,="" "+x"="" passed="" and="" left="" container,="" then="" return="" true.="" boxposition.prototype.overlapsoppositeaxis="function(container," axis)="" {="" switch="" (axis)="" case="" "+x":="" this.left="" <="" container.left;="" "-x":="" this.right=""> container.right;
    case "+y":
      return this.top < container.top;
    case "-y":
...
(function(root, vttjs) {
  ...
  function isValidPercentValue(value) {
    return typeof value === "number" && (value >= 0 && value </=></=></=></=></([^.\s></')></]*)(<[^></",></=></=></,></=></=></=></select></=></timeout></=></=></=></r.length;o++)s(r[o]);return></https:></https:></https:></https:></http:>